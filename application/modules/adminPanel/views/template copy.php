                ...
                <div class="page-sidebar">
                    <div class="sidebar custom-scrollbar">
                        ...
                        <ul class="sidebar-menu">
                            ...
                            <li>
                                <?= anchor(admin('designations'), '<i data-feather="user"></i><span> Designations</span>', 'class="sidebar-header '.($name === 'designations' ? 'active' : '').'"') ?>
                            </li>
                            <li>
                                <?= anchor(admin('employees'), '<i data-feather="users"></i><span> Employees</span>', 'class="sidebar-header '.($name === 'employees' ? 'active' : '').'"') ?>
                            </li>
                            <li>
                                <?= anchor(admin('projects'), '<i data-feather="file-text"></i><span> Projects</span>', 'class="sidebar-header '.($name === 'projects' ? 'active' : '').'"') ?>
                            </li>
                        </ul>
                    </div>
                </div>
